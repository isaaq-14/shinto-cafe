  ...
  return (
    <section className="menu on-green" id="menu" aria-labelledby="menu-h">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <div className="wrap">
          {/* forceMount keeps every tab's dishes in the page (so search engines see the whole menu and
              jump-to-dish targets always exist); inactive tabs are just hidden. */}
          {MENU.map((t) => (
            <TabsContent key={t.id} value={t.id} forceMount className="data-[state=inactive]:hidden">
              {t.sections.map((s) => (
